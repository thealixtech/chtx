...
class AdcashAntiAdblock_eiowux7mgu
{
    const ADCASH_ZONE_ID = 'eiowux7mgu';
    const ADCASH_ZONE_TYPE = 'atag';
    const ADCASH_SERVER_DOMAIN = 'geniusdexchange.com';
...
$adblock = new AdcashAntiAdblock_eiowux7mgu();
echo $adblock->run();